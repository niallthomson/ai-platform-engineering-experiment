...
# From https://github.com/cnoe-io/cnoe-agent-utils/blob/main/cnoe_agent_utils/tracing/a2a_disabler.py
...
def disable_a2a_tracing() -> bool:
    ...
    try:
        ...
        def noop_trace_class(
            cls: Union[C, None] = None, **_kwargs: Any
        ...
        logger.error(f"A2A monkey patching failed: {e}")
        return False
